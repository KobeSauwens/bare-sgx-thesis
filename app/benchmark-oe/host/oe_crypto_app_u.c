...
oe_result_t oe_crypto_app_oe_encl_op_hmac(
    ...
    uint32_t data_len)
{
    ...
    /* Marshalling struct. */
    oe_encl_op_hmac_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    _args.digest = (uint8_t*)digest;
    _args.data = (uint8_t*)data;
    _args.data_len = data_len;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(oe_encl_op_hmac_args_t));
    if (data)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.data_len);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(oe_encl_op_hmac_args_t));
    if (digest)
    ...
    _pargs_in = (oe_encl_op_hmac_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (data)
        OE_WRITE_IN_PARAM(data, 1, _args.data_len, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _oe_crypto_app_ecall_info_table[oe_crypto_app_fcn_id_oe_encl_op_hmac].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (oe_encl_op_hmac_args_t*)_output_buffer;
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _oe_crypto_app_ecall_info_table[oe_crypto_app_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(oe_crypto_app_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t oe_crypto_app_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    oe_report_buffer_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _oe_crypto_app_ecall_info_table[oe_crypto_app_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(oe_crypto_app_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t oe_crypto_app_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _oe_crypto_app_ecall_info_table[oe_crypto_app_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(oe_crypto_app_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t oe_crypto_app_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _oe_crypto_app_ecall_info_table[oe_crypto_app_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(oe_crypto_app_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t oe_crypto_app_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _oe_crypto_app_ecall_info_table[oe_crypto_app_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(oe_crypto_app_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
static oe_ocall_func_t _oe_crypto_app_ocall_function_table[] = {
...
oe_result_t oe_create_oe_crypto_app_enclave(
    const char* path,
